...
let productoSeleccionado = parseInt(prompt(
    "Ingresa el numero del producto que quieras comprar: 1.Cuadro - 2.Posters - 3.Impresion de fotografia - 4. Producto Personalizado"))
...
while (seguirComprando === true) {
    if (productoSeleccionado === 1) {
        ...
        productoSeleccionado = parseInt(
            prompt(
                "Ingresa un producto existente: Ingresa el numero del producto que quieras comprar: 1.Cuadro, 2.Posters, 3.Impresion de fotografia"))
        continue
    }
    ...
    if (decision === 1) {
        productoSeleccionado = parseInt(prompt(
            "Ingresa el numero del producto que quieras comprar: 1.Cuadro - 2.Posters - 3.Impresion de fotografia"))
    } else if (decision === 2) {
